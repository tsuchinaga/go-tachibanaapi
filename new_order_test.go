	...
	tests := []struct {
		...
		{name: "現物の成行注文レスポンスをパースして返せる",
			...
			want1: &NewOrderResponse{
				...
				WarningText:    "",
				OrderNumber:    "8004358",
				ExecutionDay:   time.Date(2022, 3, 8, 0, 0, 0, 0, time.Local),
				DeliveryAmount: 2303,
				Commission:     70,
				CommissionTax:  7,
				Interest:       0,
